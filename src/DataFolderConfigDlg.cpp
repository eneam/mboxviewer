...
BOOL DataFolderConfigDlg::OnInitDialog()
{
	...
	m_introText.SetWindowText(L"This dialog enables users to configure root data folder."
		" MBox Viewer will create UMBoxViewer folder under the configured root data folder"
		" for all files generated by MBox Viewer such as mails exported in PDF format.\r\n\r\n"
		"!!! Data Folder path should be as short as possible to avoid truncation of names of files generated by MBox Viewer."
	...
	{ 
		{  //  CBrowseForFolder bff will be deleted upon exit of this block
			...
			if (bff.SelectFolder())
			{
				...
				{
					CString text;
					text.Format(L"Selected folder \"%s\" is readonly\n. Try again or cancel", path);
...
void DataFolderConfigDlg::OnBnClickedOk()
{
	...
	if (!m_strCurrentDataFolder.IsEmpty())
	{
		CString txt = L"Root Data Folder is about to change from:\n\n\"" + m_strCurrentDataFolder + L"\"";
		txt += L"\n\nTo new Root Data Folder:\n\n\"" + m_strUserConfiguredDataFolder + L"\"";
