...
void ColorStyleConfigDlg::OnBnClickedButtonHelp()
{
	...
	text.Append(
		...
		"The dialog offers eight predefined color styles users can evalute before attempting to configure the custom color style."
		" It is helpfull to open one of the mails with attachments to help to evalute predefined and custom color styles.<br>"
		"<br>"
		...
		"The top raw of the Custom Colors area will initially be prepopulated with the colors associated with each pane.<br><br>"
