...
REM This script is working example script to render subset of HTML files listed in the text file to PDF using headless Chrome CANARY Browser tool.
...
echo "%CmdPath%"  --headless --disable-gpu --print-to-pdf-no-header --print-to-pdf="%PDF_GROUP_DIR%\%HTMLNameBase%.pdf" !%HTMLFilePath%!
call "%CmdPath%"  --headless --disable-gpu --print-to-pdf-no-header --print-to-pdf="%PDF_GROUP_DIR%\%HTMLNameBase%.pdf" !%HTMLFilePath%!
