...
set cmd=call !ExePath!  --headless=new --disable-gpu --no-pdf-header-footer --print-to-pdf-no-header --print-to-pdf="!CURRENT_DIR!\!HTMLFileNameBase!.pdf" "!CURRENT_DIR!\!HTMLFileName!"
echo !cmd!
!cmd!
