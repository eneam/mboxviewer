...
REM This script is working example script to render all HTML files in the current directory to PDF using headless Chrome CANARY Browser.
...
echo "%CmdPath%"  --headless --disable-gpu --print-to-pdf-no-header --print-to-pdf="%PDFdir%\!HTMLFileNameBase!.pdf" "%CURRENT_DIR%\!HTMLFileName!"
call "%CmdPath%"  --headless --disable-gpu --print-to-pdf-no-header --print-to-pdf="%PDFdir%\!HTMLFileNameBase!.pdf" "%CURRENT_DIR%\!HTMLFileName!"
