...
echo "%CmdPath%"  --headless=old --disable-gpu --print-to-pdf-no-header --no-pdf-header-footer --print-to-pdf="%PDF_GROUP_DIR%\%HTMLNameBase%.pdf" !%HTMLFilePath%!
call "%CmdPath%"  --headless=old --disable-gpu --print-to-pdf-no-header --no-pdf-header-footer --print-to-pdf="%PDF_GROUP_DIR%\%HTMLNameBase%.pdf" !%HTMLFilePath%!
