...
v 1.0.3.27
 ...
 - MBox Viewer will remember last selection, that is, last folder, mail file, label and index and restore upon startup.;
...
v 1.0.3.24
 ...
 - Disabled "Create Folder" unfinished option left enabled by mistake while working on Gmail Labels support;
 - Updated User Manual to describe new and updated features;
...
v 1.0.2.6
 ...
 - Added option to find user defined text in the mail's message and highlight all occurrences;
 - Updated User Manual to describe new and updated features;
...
v 1.0.2.5
 ...
 - users not intereseted in the source code don't need to reinstall mboxview binary file;
...
v 1.0.2.4
 ...
 - all attachemnts are still accessible by double clicking selected email in the summary window or by selecting View->"View EML" menu option;
