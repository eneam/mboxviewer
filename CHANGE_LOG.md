...
v 1.0.3.59
 ...
 - Updated MimeKit to address security issues.;
 - Update RtfPipe to FridayForks.RtfPipe to enhance RTF parsing.;
 - Updated User Manual to describe new and updated features.;

v 1.0.3.58

 - To improve mboxview, please post reviews on what works, what doesn't, create bug tickets and enhancement requests.;
 - Enhanced processing of winmail.dat and .ms-tnef attachments.;
...
v 1.0.3.54
 ...
 - To improve mboxview, please post reviews on what works, what doesn't, create bug tickets and enhancement requests.;
 - Added support for Outlook .msg mail files.;
 - Re-enabled Refresh All Folder global button.;
...
v 1.0.3.53
 ...
 - To improve mboxview, please post reviews on what works, what doesn't, create bug tickets and enhancement requests.;
 - Added support for mail size column when printing to CSV.;
 - Fixed mail date and time processing broken in v1.0.3.49. Existing Index Files will be refreshed automatically to resolve the issue.;
 - Updated User Manual to describe new and updated features.;
...
v 1.0.3.51
 ...
 - Resolved few language translation issues.;
 - Updated User Manual to describe new and updated features.;
...
v 1.0.3.44
 ...
 - ForwardEmlFile.exe is Self-contained again, independent  from the .NET version installed on user's system.
 - Updated User Manual to describe new and updated features.;

v 1.0.3.43

 - To improve mboxview, please post reviews on what works, what doesn't, create bug tickets and enhancement requests.;
 - Added Find Advanced option to highlight search string in Message for all mails matched.;
...
v 1.0.3.42
 ...
 - To improve mboxview, please post reviews on what works, what doesn't, create bug tickets and enhancement requests.;
 - Added ability to cycle through mail summary and mail message panes using CTRL+n.;
...
v 1.0.3.2
 ...
 - Added Mail Retrieval In Progress Status text in the Status Bar;
